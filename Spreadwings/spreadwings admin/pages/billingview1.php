...
<?php
 if(isset($_REQUEST['bilid']))
    ...
    $_SESSION['billid']=$bill;
	

	$query="select * from billingadd where billadd_id=$bill";
...
?>  
 ...
 <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Billing Details</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                    ...
                                    <form role="form"  action="#"  >
									   ...
									   <div class="form-group">
										...
										<div class="form-group">
											...
											<?php
										if(isset($_SESSION['chids']))
										{
										 
										 $chk_id= $_SESSION['chids'];
									
											echo "<a href='order_info.php?chid=$chk_id'> <button type='button' class='btn btn-info'>Back</button></a>";
											unset($_SESSION["chids"]);
										}
										else
										{
											echo "<a href='billingshow.php'> <button type='button' class='btn btn-info'>Back</button></a>";
										}
										?>
