...
<form name="bf10" action="upd_billingadd3.php" method="post">

<?php
    if(isset($_REQUEST['billuserid']))
    {
	 // echo "user id: ".$_REQUEST['billuserid'];
	   
	$usids=$_REQUEST['billuserid'];

	$query="select * from billingadd where uid=$usids";
