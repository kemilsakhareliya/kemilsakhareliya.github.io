...
<form name="f11" action="ins_shippingadd.php" method="post">
...
<br>
<!--
<input type="text" name="state" id="state" required pattern="[A-Z a-z]*" title="please enter state">
<br>
<br>

city
<input type="text" name="city" id="city" required pattern="[A-Z a-z]*"title="please enter city">
<br>
<br>-->
...
phone no
<input type="text" name="pno" required pattern="[789][0-9]{9}" title="please enter phone number in 10 digit start with 789">
<br>
<br>
...
<input type="checkbox" name="check"> same for billing address
