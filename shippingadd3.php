...
<form name="update_useraddress" action="upd_shippingadd3.php" method="post">
...
phone no
<input type="text" name="pno" value="<?php echo $row['pno'];?>"  required pattern="[789][0-9]{9}" title="please enter phone number">
<br>
<br>
